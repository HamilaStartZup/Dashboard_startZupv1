    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="/Dashboard_startZupv1/liste-des-appels" class="list-group-item list-group-item-action py-2 ripple ripple active"><i class="fa-sharp fa-solid fa-list me-3"></i>
            ...
            <tbody>
              <?php
                foreach ($rows as $row) {
                  ...
                  echo "<tr>";
                  echo "<td> <h3> Appel du <b> <a href='/Dashboard_startZupv1/details-appel/".$date_Appel."'>".$date_Appel."</a> </b> </h3> </td>";
                  echo "</tr>";
                }
              ?>
            </tbody>
