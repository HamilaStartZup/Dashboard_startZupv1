...
// requête pour récupérer la liste des   rdv par client  x avec les  detalle du candidat
$queryInterview = "SELECT code_profile,
                          nom, 
                          prenom,
                          designation,
                          phone, 
                          ...
                          FROM `rdv` INNER JOIN student ON rdv.student_id= student.id;";
      ...
      <section class="mb-4">
        ...
        <div class="container py-5 h-100">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col col-xl-10">
              <?php foreach ($Interviews as $Interview) {
                ...
                <button type='button' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#staticBackdrop' data-mdb-ripple-init>annuler</button> </div>
                  ...
                  echo "<a href='delete_rdv.php?id=$Interview[id_rdv]&id_student=$_GET[users_id]&email=$_GET[email]' ><button type='button' class='btn btn-primary'>OUI</button></a>";
                  echo ' </div>
                        </div>
                      </div>
                    </div>';
                  ...
                  echo '
                  <div class="card mb-5" style="border-radius: 15px;background-color: #d7f8db;">
                  <div class="card-body p-4">
                  <div class="row">
                    <div class="col-2">';
                  echo "<button type='button' class='btn btn-lg shadow-lg p-3 mb-5  rounded' style='background-color:#A648C2 ;'> $Interview[code_profile]</button>";
            ...
            <button type="submit" class="btn disabled btn-success">valider</button>
            </from>';


                  echo "
            <button type='button' class='btn disabled btn-danger'>annuler</button> </div>
            </div>
