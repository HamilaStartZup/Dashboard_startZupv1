...
<body>
    ...
    <header>
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                ...
                <a href="/Dashboard_startZupv1/ajouter-une-langue" class="list-group-item list-group-item-action py-2 ripple active"><i class="fas fa-chart-line fa-fw me-3"></i><span>Ajouter une langue</span></a>
    ...
    <form action="./addLanguageDB.php" method="POST" class="formulaire" enctype="multipart/form-data">
        <h3>Créer une nouvelle langue !</h3>
        <div class="mb-3">
            <label for="nom_language" class="form-label">Nom de la nouvelle langue</label>
            <input type="text" class="form-control" id="nom_language" name="nom_language" required>
            <label for="code" class="form-label">Code de la nouvelle langue</label>
            <input type="text" class="form-control" id="code" name="code" required>
            <label for="flag" class="form-label">Drapeau de la nouvelle langue</label>
            <input type="file" class="form-control" id="flag" name="flag" >
        </div>
        <button type="submit" class="btn btn-primary">Ajouter</button>
    </form>

    <h1>Langage existant</h1>
    <table class="table">
        <thead>
            <tr>
                <th scope="col">Nom de la langue</th>
                <th scope="col">Code de la langue</th>
                <th scope="col">Drapeau de la langue</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            foreach ($languages as $language) {
                echo "<tr>";
                echo "<td>" . $language['nom_language'] . "</td>";
                echo "<td>" . $language['code'] . "</td>";
                echo "<td><img src='" . $language['flag'] . "' width='50px' height='50px'></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
